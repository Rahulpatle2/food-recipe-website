...
const Navbar = () => {
  ...
  return (
      ...
      <div className='flex lg:flex-row flex-col  absolute top-10 lg:bg-white lg:relative lg:top-0 lg:left-0  lg:gap-10  p-5 rounded bg-[#ebebeb] right-5 gap-5 lg:items-center lg:w-full'>
